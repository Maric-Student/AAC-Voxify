...
function AppContent() {
  ...
  // State for settings
  const [language, setLanguage] = useState<"english" | "tagalog" | "bilingual">("english")
  const [colorblindMode, setColorblindMode] = useState<string>("none")

  // Get auth context
  const { user, isAuthenticated, logout } = useAuth()

  // Multilingual word data
  const wordData = {
    english: {
      categories: [
        { id: 1, name: "Common" },
    ...
    bilingual: {
      categories: [
        { id: 1, name: "Common / Karaniwan" },
        { id: 2, name: "Actions / Mga Aksyon" },
        { id: 3, name: "Feelings / Mga Damdamin" },
        { id: 4, name: "Food / Pagkain" },
        { id: 5, name: "Places / Mga Lugar" },
        { id: 6, name: "People / Mga Tao" },
        { id: 7, name: "Time / Oras" },
        { id: 8, name: "Colors / Mga Kulay" },
      ],
      words: {
        1: [
          { id: 1, text: "I, me, my / Ako, akin", imageUrl: "/placeholder.svg?height=100&width=100", categoryId: 1 },
          { id: 2, text: "you / ikaw", imageUrl: "/placeholder.svg?height=100&width=100", categoryId: 1 },
          { id: 3, text: "yes / oo", imageUrl: "/placeholder.svg?height=100&width=100", categoryId: 1 },
          { id: 4, text: "no / hindi", imageUrl: "/placeholder.svg?height=100&width=100", categoryId: 1 },
          { id: 5, text: "please / pakiusap", imageUrl: "/placeholder.svg?height=100&width=100", categoryId: 1 },
          { id: 6, text: "thank you / salamat", imageUrl: "/placeholder.svg?height=100&width=100", categoryId: 1 },
          { id: 7, text: "hello / kumusta", imageUrl: "/placeholder.svg?height=100&width=100", categoryId: 1 },
          { id: 8, text: "goodbye / paalam", imageUrl: "/placeholder.svg?height=100&width=100", categoryId: 1 },
          { id: 9, text: "help / tulong", imageUrl: "/placeholder.svg?height=100&width=100", categoryId: 1 },
          { id: 10, text: "more / pa", imageUrl: "/placeholder.svg?height=100&width=100", categoryId: 1 },
        ],
        2: [
          { id: 11, text: "go / punta", imageUrl: "/placeholder.svg?height=100&width=100", categoryId: 2 },
          { id: 12, text: "stop / hinto", imageUrl: "/placeholder.svg?height=100&width=100", categoryId: 2 },
          { id: 13, text: "eat / kain", imageUrl: "/placeholder.svg?height=100&width=100", categoryId: 2 },
          { id: 14, text: "drink / inom", imageUrl: "/placeholder.svg?height=100&width=100", categoryId: 2 },
          { id: 15, text: "play / laro", imageUrl: "/placeholder.svg?height=100&width=100", categoryId: 2 },
          { id: 16, text: "sleep / tulog", imageUrl: "/placeholder.svg?height=100&width=100", categoryId: 2 },
          { id: 17, text: "want / gusto", imageUrl: "/placeholder.svg?height=100&width=100", categoryId: 2 },
          { id: 18, text: "give / bigay", imageUrl: "/placeholder.svg?height=100&width=100", categoryId: 2 },
          { id: 19, text: "get / kuha", imageUrl: "/placeholder.svg?height=100&width=100", categoryId: 2 },
          { id: 20, text: "make / gawa", imageUrl: "/placeholder.svg?height=100&width=100", categoryId: 2 },
        ],
        3: [
          { id: 21, text: "happy / masaya", imageUrl: "/placeholder.svg?height=100&width=100", categoryId: 3 },
          { id: 22, text: "sad / malungkot", imageUrl: "/placeholder.svg?height=100&width=100", categoryId: 3 },
          { id: 23, text: "angry / galit", imageUrl: "/placeholder.svg?height=100&width=100", categoryId: 3 },
          { id: 24, text: "scared / takot", imageUrl: "/placeholder.svg?height=100&width=100", categoryId: 3 },
          { id: 25, text: "tired / pagod", imageUrl: "/placeholder.svg?height=100&width=100", categoryId: 3 },
          { id: 26, text: "sick / may sakit", imageUrl: "/placeholder.svg?height=100&width=100", categoryId: 3 },
          { id: 27, text: "hurt / masakit", imageUrl: "/placeholder.svg?height=100&width=100", categoryId: 3 },
          { id: 28, text: "love / mahal", imageUrl: "/placeholder.svg?height=100&width=100", categoryId: 3 },
          { id: 29, text: "like / gusto", imageUrl: "/placeholder.svg?height=100&width=100", categoryId: 3 },
          { id: 30, text: "don't like / ayaw", imageUrl: "/placeholder.svg?height=100&width=100", categoryId: 3 },
        ],
        4: [
          { id: 31, text: "water / tubig", imageUrl: "/placeholder.svg?height=100&width=100", categoryId: 4 },
          { id: 32, text: "milk / gatas", imageUrl: "/placeholder.svg?height=100&width=100", categoryId: 4 },
          { id: 33, text: "juice / juice", imageUrl: "/placeholder.svg?height=100&width=100", categoryId: 4 },
          { id: 34, text: "apple / mansanas", imageUrl: "/placeholder.svg?height=100&width=100", categoryId: 4 },
          { id: 35, text: "banana / saging", imageUrl: "/placeholder.svg?height=100&width=100", categoryId: 4 },
          { id: 36, text: "bread / tinapay", imageUrl: "/placeholder.svg?height=100&width=100", categoryId: 4 },
          { id: 37, text: "cookie / biskwit", imageUrl: "/placeholder.svg?height=100&width=100", categoryId: 4 },
          { id: 38, text: "pizza / pizza", imageUrl: "/placeholder.svg?height=100&width=100", categoryId: 4 },
          { id: 39, text: "chicken / manok", imageUrl: "/placeholder.svg?height=100&width=100", categoryId: 4 },
          { id: 40, text: "ice cream / ice cream", imageUrl: "/placeholder.svg?height=100&width=100", categoryId: 4 },
        ],
        5: [
          { id: 41, text: "home / bahay", imageUrl: "/placeholder.svg?height=100&width=100", categoryId: 5 },
          { id: 42, text: "school / paaralan", imageUrl: "/placeholder.svg?height=100&width=100", categoryId: 5 },
          { id: 43, text: "park / parke", imageUrl: "/placeholder.svg?height=100&width=100", categoryId: 5 },
          { id: 44, text: "store / tindahan", imageUrl: "/placeholder.svg?height=100&width=100", categoryId: 5 },
          { id: 45, text: "bathroom / banyo", imageUrl: "/placeholder.svg?height=100&width=100", categoryId: 5 },
          { id: 46, text: "bedroom / kwarto", imageUrl: "/placeholder.svg?height=100&width=100", categoryId: 5 },
          { id: 47, text: "kitchen / kusina", imageUrl: "/placeholder.svg?height=100&width=100", categoryId: 5 },
          { id: 48, text: "outside / labas", imageUrl: "/placeholder.svg?height=100&width=100", categoryId: 5 },
          { id: 49, text: "inside / loob", imageUrl: "/placeholder.svg?height=100&width=100", categoryId: 5 },
          { id: 50, text: "car / kotse", imageUrl: "/placeholder.svg?height=100&width=100", categoryId: 5 },
        ],
      },
    },
  }
  ...
  for (let i = 6; i <= 8; i++) {
    wordData.english.words[i] = Array.from({ length: 10 }, (_, j) => ({
      id: i * 100 + j,
      text: `Word ${i * 100 + j}`,
    ...
    wordData.tagalog.words[i] = Array.from({ length: 10 }, (_, j) => ({
      id: i * 100 + j,
      text: `Salita ${i * 100 + j}`,
      imageUrl: "/placeholder.svg?height=100&width=100",
      categoryId: i,
    ...
    wordData.bilingual.words[i] = Array.from({ length: 10 }, (_, j) => ({
      id: i * 100 + j,
      text: `Word ${i * 100 + j} / Salita ${i * 100 + j}`,
      imageUrl: "/placeholder.svg?height=100&width=100",
      categoryId: i,
    }))
  }
  ...
  const translations = {
    ...
    bilingual: {
      appTitle: "Voxify AAC",
      selectWords: "Select words / Pumili ng mga salita",
      speak: "Speak / Magsalita",
      clear: "Clear / Burahin",
      remove: "Remove / Alisin",
      addWord: "Add Word / Magdagdag",
      login: "Log In / Mag-login",
      signup: "Sign Up / Mag-sign up",
      logout: "Log Out / Mag-logout",
      profile: "Profile / Profile",
      loginPrompt:
        "Create an account to save your words across devices / Gumawa ng account para i-save ang iyong mga salita",
      createAccount: "Create Account / Gumawa ng Account",
      notSaved:
        "Words added will be saved on this device only / Ang mga salitang idinagdag ay mase-save lamang sa device na ito",
      typeHere: "Type here... / Mag-type dito...",
      editWord: "Edit Word / I-edit ang Salita",
    },
  }
  ...
  useEffect(() => {
    ...
    if (
      savedLanguage &&
      (savedLanguage === "english" || savedLanguage === "tagalog" || savedLanguage === "bilingual")
    ) {
   ...
   */
  const handleLanguageChange = (newLanguage: "english" | "tagalog" | "bilingual") => {
        ...
        <div className="message-bar mb-2">
          ...
          <div className="action-buttons">
            <button
              ...
              className="action-button action-button-speak"
              aria-label={t.speak}
              title={t.speak}
            >
