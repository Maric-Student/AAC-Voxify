...
interface SettingsSidebarProps {
  ...
  onLanguageChange: (language: "english" | "tagalog" | "bilingual") => void
            ...
            <div className="mb-4">
              ...
              <div className="space-y-2">
                {[
                  ...
                  { value: "bilingual", label: "Bilingual / Dalawahang-wika" },
                ].map((option) => (
                  <label
                    key={option.value}
                  ...
                  >
                    ...
                    <input
                      ...
                      onChange={() => onLanguageChange(option.value as "english" | "tagalog" | "bilingual")}
                      className="sr-only"
                    />
                  </label>
                ))}
